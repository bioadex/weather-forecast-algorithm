...
The accuracy of the weather forecasting models varies for different weather variables. Below are performance metrics for temperature (`temp_2`) in Berlin and wind speed (`w_speed`) in Halle:

- **Temperature (temp_2) in Berlin:**
  - MAE: 2.67
  - MSE: 11.48
  - R2: 0.88

- **Wind Speed (w_speed) in Halle:**
  - MAE: 6.79
  - MSE: 72.29
  - R2: 0.16
...
1. **Temperature Prediction in Berlin:**
   ![Temperature Prediction](images/temperature_forecast_plot_berlin.png)
...
2. **Wind Speed Prediction in Halle:**
